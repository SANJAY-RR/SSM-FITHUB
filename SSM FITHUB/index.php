...
<link rel="stylesheet" href="popup_style.css">
  <!--  Project Developed by: SSM team. 
 for any PHP, Codeignitor or Laravel work contact me through www.ssmteam.com  --> 
...
<?php
             ...
             ?>
            <div class="container-fluid" style="background-image: url('./Logos/<?php echo $row_login['background_login_image'];?>');
 background-color: #cccccc;">
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        <div class="login-content card">
                            <center><img src="./Logos/<?php echo $row_login['login_logo'];?>" style="width:100%;"></center><br><!-- <h4>Login</h4> -->
